...
export default function TrustedPartners() {
  return (
    <section className="relative flex flex-col items-center overflow-hidden bg-white py-10 sm:py-12 lg:py-14">
      ...
      <Container className="flex w-full flex-col items-center">
        <div className="mx-auto flex w-full max-w-6xl flex-col items-center text-center">
          <span className="inline-flex items-center justify-center gap-2 rounded-full border border-[#E5E7EB]/80 bg-[#E8F8EF] px-5 py-2.5 text-sm font-semibold text-[#16A34A] shadow-[0_2px_12px_rgba(22,163,74,0.08)]">
            Trusted Partners
          </span>

          <h2 className="mx-auto mt-10 max-w-4xl text-center text-[32px] font-extrabold leading-[1.15] tracking-[-0.02em] text-[#0F172A] md:text-[40px] lg:text-[48px]">
            Working Together With India&apos;s most Trusted NGO and
            <span className="text-[#16A34A]"> Food Relief Organizations</span>
          </h2>

          <p className="mx-auto mt-10 max-w-4xl text-center text-lg leading-8 text-slate-600">
        ...
        <div className="mt-6 flex items-stretch justify-center gap-6 overflow-x-auto pb-2 sm:mt-8 md:mt-10 [-ms-overflow-style:none] [scrollbar-width:none] lg:grid lg:grid-cols-6 lg:gap-8 lg:overflow-visible [&::-webkit-scrollbar]:hidden">
        ...
        <p className="mx-auto mt-14 max-w-3xl text-center text-base leading-7 text-[#64748B] md:mt-16">
