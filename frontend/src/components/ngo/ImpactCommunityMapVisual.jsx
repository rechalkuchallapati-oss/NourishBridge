...
export default function ImpactCommunityMapVisual() {
  return (
    <section className="nb-card rounded-[18px] border border-[#E5E7EB] bg-white p-6 shadow-sm">
      ...
      <div className="relative mt-[0.5cm] aspect-[16/10] overflow-hidden rounded-[16px] border border-[#E5E7EB] bg-gradient-to-br from-[#EFF6FF] to-[#F0FDF4]">
        ...
        {COMMUNITY_COVERAGE.map((area) => (
          ...
          >
            <span className="whitespace-nowrap rounded-full bg-[#16A34A] px-2 py-0.5 text-[10px] font-semibold text-white shadow-sm">
              {area.label}
            </span>
        ...
        <div className="absolute bottom-2 left-2 rounded-[10px] bg-white/90 px-2 py-1 text-[10px] font-medium text-[#64748B]">
